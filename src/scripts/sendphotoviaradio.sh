...
for item in $(ls -1); do
  ...
  echo "convert $item -resize 320x256! -pointsize 36 -fill white -annotate +10+40 'CQ IQ0OS' -pointsize 24 -fill white -annotate +10+70 '#MKFR2025  73!' -pointsize 20 -fill white -annotate +10+95 '$DATA' ../images/AriOstia_logo_mini.png -gravity northeast -composite /tmp/step1.jpg;convert /tmp/step1.jpg ../images/logo_faro_mini.png -gravity east -composite /tmp/step2.jpg ;convert /tmp/step2.jpg ../images/logo-birdgarden-mini.png -gravity southeast -composite /tmp/final.jpg">/tmp/step_convert.sh
