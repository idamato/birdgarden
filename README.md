...
Per il collegamento attraverso la porta seriale è necessario abilitarne l'accesso nel file config.txt inserendo la seguente riga: <!-- ` - Single backtick -->enable_uart=1<!-- ` - Single backtick -->
